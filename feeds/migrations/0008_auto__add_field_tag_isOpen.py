...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tag.isOpen'
        db.add_column(u'feeds_tag', 'isOpen',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tag.isOpen'
        db.delete_column(u'feeds_tag', 'isOpen')
    ...
    models = {
        ...
        u'feeds.tag': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'isOpen': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
